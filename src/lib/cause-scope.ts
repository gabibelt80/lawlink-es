...
// SegÃºn el CÃ³digo Civil y Comercial de la NaciÃ³n y la Ley de Arbitraje 27.449
...
export const ARGENTINA_COMMERCIAL_ARBITRATION_INCLUDE_PREFIXES = [
  ...
  "CC-6", // DaÃ±os y responsabilidad civil
  "CC-8", // Sociedades y empresas
  "CC-9" // Seguros, tÃ­tulos valores, garantÃ­as
] as const;
...
export const ARGENTINA_COMMERCIAL_ARBITRATION_EXCLUDE_PREFIXES = [
  ...
  "CC-8-22-237", // DaÃ±os ambientales (competencia exclusiva de la Justicia Ambiental)
  "CC-9-24-315", // DisoluciÃ³n de sociedades (competencia exclusiva de la Justicia Comercial)
  "CC-9-26-325", // Cooperativas (competencia exclusiva de la Justicia Comercial)
  "CC-9-26-326", // LiquidaciÃ³n de cooperativas
