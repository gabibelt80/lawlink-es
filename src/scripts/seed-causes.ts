...
async function main() {
  ...
  const causes = [
    ...
    { category: "CIVIL_COMMERCIAL", code: "CC-1-2", name: "LocaciÃ³n", level: 2, parentCode: "CC-1" },
    ...
    { category: "CIVIL_COMMERCIAL", code: "CC-1-6", name: "DonaciÃ³n", level: 2, parentCode: "CC-1" },
    ...
    { category: "CIVIL_COMMERCIAL", code: "CC-2-1", name: "DaÃ±os y perjuicios", level: 2, parentCode: "CC-2" },
    { category: "CIVIL_COMMERCIAL", code: "CC-2-2", name: "Mala praxis", level: 2, parentCode: "CC-2" },
    { category: "CIVIL_COMMERCIAL", code: "CC-2-3", name: "Accidentes de trÃ¡nsito", level: 2, parentCode: "CC-2" },
    { category: "CIVIL_COMMERCIAL", code: "CC-3", name: "Derechos reales", level: 1 },
    { category: "CIVIL_COMMERCIAL", code: "CC-3-1", name: "PosesiÃ³n", level: 2, parentCode: "CC-3" },
    ...
    { category: "CIVIL_COMMERCIAL", code: "CC-3-4", name: "UsucapiÃ³n", level: 2, parentCode: "CC-3" },
    ...
    { category: "CIVIL_COMMERCIAL", code: "CC-4-3", name: "RÃ©gimen de visitas", level: 2, parentCode: "CC-4" },
    { category: "CIVIL_COMMERCIAL", code: "CC-4-4", name: "FiliaciÃ³n", level: 2, parentCode: "CC-4" },
    { category: "CIVIL_COMMERCIAL", code: "CC-4-5", name: "AdopciÃ³n", level: 2, parentCode: "CC-4" },
    ...
    { category: "CIVIL_COMMERCIAL", code: "CC-5-1", name: "RelaciÃ³n de consumo", level: 2, parentCode: "CC-5" },
    ...
    { category: "CIVIL_COMMERCIAL", code: "CC-6-3", name: "VerificaciÃ³n de crÃ©ditos", level: 2, parentCode: "CC-6" },
    ...
    { category: "CIVIL_COMMERCIAL", code: "CC-7-2", name: "ImpugnaciÃ³n de asambleas", level: 2, parentCode: "CC-7" },
    { category: "CIVIL_COMMERCIAL", code: "CC-7-3", name: "RendiciÃ³n de cuentas", level: 2, parentCode: "CC-7" },
    ...
    { category: "LABOR_ARBITRATION", code: "LA-1-8", name: "ReincorporaciÃ³n", level: 2, parentCode: "LA-1" },
    ...
    { category: "CRIMINAL", code: "CR-2-4", name: "DefraudaciÃ³n", level: 2, parentCode: "CR-2" },
    { category: "CRIMINAL", code: "CR-2-5", name: "UsurpaciÃ³n", level: 2, parentCode: "CR-2" },
    { category: "CRIMINAL", code: "CR-3", name: "Contra la administraciÃ³n pÃºblica", level: 1 },
    { category: "CRIMINAL", code: "CR-3-1", name: "Cohecho", level: 2, parentCode: "CR-3" },
    { category: "CRIMINAL", code: "CR-3-2", name: "MalversaciÃ³n", level: 2, parentCode: "CR-3" },
    { category: "CRIMINAL", code: "CR-3-3", name: "Enriquecimiento ilÃ­cito", level: 2, parentCode: "CR-3" },
    { category: "CRIMINAL", code: "CR-4", name: "Drogas", level: 1 },
    { category: "CRIMINAL", code: "CR-4-1", name: "Tenencia", level: 2, parentCode: "CR-4" },
    { category: "CRIMINAL", code: "CR-4-2", name: "TrÃ¡fico", level: 2, parentCode: "CR-4" },
    { category: "CRIMINAL", code: "CR-5", name: "Ambientales", level: 1 },
    { category: "CRIMINAL", code: "CR-5-1", name: "ContaminaciÃ³n", level: 2, parentCode: "CR-5" },
