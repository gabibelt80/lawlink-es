...
// checklist item.id → DocumentCategory（Usado para clasificar al subir）
...
export function ArchiveWizardDialog({ matterId, open, onOpenChange }: Props) {
  ...
  async function refreshPrep() {
    ...
    // De los materiales ya subidos item Marcar automaticamente
  ...
  async function handleFileSelected(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    e.target.value = ""; // Permitir elegir el mismo archivo dos veces
        ...
        {loading ? (
          ...
          <ScrollArea className="max-h-[60vh] pr-4">
            <div className="space-y-5">
              ...
              <section className="space-y-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    placeholder="Como：Sentencia de primera instancia acepta la demanda del actor，La contraparte no apelo，Sentencia en 2026-04-15 Vigente"
                    rows={2}
                  />
                </div>
                <div className="space-y-1.5">
              ...
              {/* FaltaítemsAdvertencia - Rojo + Avisar primero de subir materiales del expediente */}
              ...
              {/* v0.16: AprobaciónAviso de flujo */}
